...
![test workflow status](https://github.com/markjoyeuxcom/terraform-provider-pihole/actions/workflows/test.yml/badge.svg?branch=main) [![terraform registry](https://img.shields.io/badge/terraform-registry-623CE4)](https://registry.terraform.io/providers/markjoyeuxcom/pihole/latest/docs)
...
See the [provider documentation](https://registry.terraform.io/providers/markjoyeuxcom/pihole/latest/docs) for more details.
...
> see https://github.com/markjoyeuxcom/terraform-provider-pihole/blob/main/.goreleaser.yml#L18-L27
...
> [!NOTE]
> For the current tests in this repository the SDKv2 is used. In issue [#4](https://github.com/markjoyeuxcom/terraform-provider-pihole/issues/38) an upgrade from SDKv2 to [plugin-testing](https://developer.hashicorp.com/terraform/plugin/framework) can be tracked.
